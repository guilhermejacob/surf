context("svyflow estimates with nonresponse: Model C")
...
flow_srs_lin <- svyflow( ~v0+v1 , des.lin , model = "C" , verbose = FALSE , influence = TRUE )
flow_srs_rep <- svyflow( ~v0+v1 , des.rep , model = "C" , verbose = FALSE , influence = TRUE )
