...
suppressWarnings( flow_srs_lin <- svyflow( ~v0+v1 , des.lin , model = "C" , verbose = FALSE , as.zero.flows = TRUE , influence = TRUE ) )
suppressWarnings( flow_srs_rep <- svyflow( ~v0+v1 , des.rep , model = "C" , verbose = FALSE , as.zero.flows = TRUE , influence = TRUE ) )
