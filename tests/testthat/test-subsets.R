...
test_that("compare linearized vs replicate: standard errors",{
  expect_equal( SE( gflow_lin_sub1 ) , SE( gflow_rep_sub1 ) , tolerance = .4 )
  expect_equal( SE( gflow_lin_sub2 ) , SE( gflow_rep_sub2 ) , tolerance = .4 )
  expect_equal( SE( nflow_lin_sub1 ) , SE( nflow_rep_sub1 ) , tolerance = .4 )
  expect_equal( SE( nflow_lin_sub2 ) , SE( nflow_rep_sub2 ) , tolerance = .4 )
} )
test_that("compare linearized vs replicate: coefficients of variation",{
  expect_equal( cv( gflow_lin_sub1 ) , cv( gflow_rep_sub1 ) , tolerance = .4 )
  expect_equal( cv( gflow_lin_sub2 ) , cv( gflow_rep_sub2 ) , tolerance = .4 )
  expect_equal( cv( nflow_lin_sub1 ) , cv( nflow_rep_sub1 ) , tolerance = .4 )
  expect_equal( cv( nflow_lin_sub2 ) , cv( nflow_rep_sub2 ) , tolerance = .4 )
} )
