...
suppressWarnings( flow_srs_lin <- svyflow( ~v0+v1 , des.lin , model = "D" , verbose = FALSE , as.zero.flows = TRUE ) )
suppressWarnings( flow_srs_rep <- svyflow( ~v0+v1 , des.rep , model = "D" , verbose = FALSE , as.zero.flows = TRUE ) )
