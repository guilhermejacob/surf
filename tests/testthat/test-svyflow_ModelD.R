context("svyflow estimates with nonresponse: Model D")
...
flow_srs_lin <- svyflow( ~v0+v1 , des.lin , model = "D" , verbose = FALSE , influence = TRUE )
flow_srs_rep <- svyflow( ~v0+v1 , des.rep , model = "D" , verbose = FALSE , influence = TRUE )
